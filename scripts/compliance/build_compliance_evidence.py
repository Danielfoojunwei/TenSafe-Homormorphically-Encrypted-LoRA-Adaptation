...
class EvidenceBuilder:
    ...
    def generate_markdown(self, report: EvidenceReport) -> str:
        ...
        lines.append("| Control Matrix | `docs/compliance/CONTROL_MATRIX.md` | Control definitions |")
        lines.append("")

        # Footer
        lines.append("---")
        lines.append("")
        lines.append("_Report generated by TensorGuard Compliance Evidence Builder v1.0_")
        lines.append("")
